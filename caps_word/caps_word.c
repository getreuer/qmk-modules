...
/**
 * @file caps_word.c
 * @brief Caps Word community module implementation
 *
...
#pragma message \
    "getreuer/caps_word: Caps Word has evolved into core QMK feature Caps Word! To use it, update your QMK set up and see https://docs.qmk.fm/features/caps_word"

ASSERT_COMMUNITY_MODULES_MIN_API_VERSION(1, 0, 0);

#ifdef CAPS_WORD_ENABLE
#error "getreuer/caps_word: This module is an alternative to QMK core's built-in Caps Word feature (`CAPS_WORD_ENABLE = yes`). Please do not enable both at the same time."
#else
...
void housekeeping_task_caps_word(void) {
